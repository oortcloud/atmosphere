(function () {
  ...
  Template.loginButtonsServicesRow.fields = function () {
    var loginFields = [
      {fieldName: 'username-or-email', fieldLabel: 'Username or Email', inputType: 'text',
       visible: function () {
         return Meteor.accounts._options.requireUsername
           && Meteor.accounts._options.requireEmail;
       }},
      {fieldName: 'username', fieldLabel: 'Username', inputType: 'text',
       visible: function () {
         return Meteor.accounts._options.requireUsername
           && !Meteor.accounts._options.requireEmail;
       }},
      {fieldName: 'email', fieldLabel: 'Email', inputType: 'text',
       visible: function () {
         return !Meteor.accounts._options.requireUsername;
       }},
